...
const ProductCardDes = ({ product }) => {
  return (
    <div className="tw-hidden md:tw-flex tw-flex-col tw-gap-y-6 tw-basis-1/4 tw-p-[15px]">
      <Image
        src={product.photo}
        alt="photo"
        height="100%"
        className="tw-h-[427px] tw-w-full"
      />
